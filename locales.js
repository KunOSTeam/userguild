const en_US = {
  WIN_TITLE: 'Welcome to KunOS',
  
  LANG_TITLE: 'Language',
  LANG_DESC: 'Before you begin, please set your language.',
  
  ABOUT_TITLE: 'About KunOS',
  ABOUT_DESC: 'KunOS, formerly called OS.js Linux, is a lightweight web-based Linux distro powered by OS.js. It uses the power of Electron to run a web-based desktop environment, OS.js, to provide the user with a more web-based experience.',
